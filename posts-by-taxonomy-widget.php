...
class pbtw_wrapper extends WP_Widget {
							...
							foreach( $terms as $term ) {
								echo '<li class="posts-by-taxonomy-term ' . $term->slug . '">' . $term->name;
									echo '<ul class="posts-by-taxonomy-post-list">';
										...
										$term_post_args = array( 'posts_per_page' => $number, 'tax_query' => $tax_query );
    ...
    function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('tax'); ?>"><?php _e('Choose the Taxonomy to Show Terms and Posts From'); ?></label>
